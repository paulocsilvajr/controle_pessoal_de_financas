...
docker run -it --rm -v $DIR_ABS:/go/src/controle_pessoal_de_financas golang_custom:controle_pessoal_de_financas ./github.com/paulocsilvajr/controle_pessoal_de_financas/API/v1/compile_static_linux_amd64.sh
