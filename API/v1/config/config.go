...
var Rotas = rotas{
	...
	"PessoaIndex": rota{
		...
		"/pessoas",
		"",
		`{"status":int, "message":"string", "count":int, "data": [ {"cpf":"string", "nome_completo":"string", "usuario":"string", "senha":"string", "email":"string", "data_criacao":"YYYY-MM-DDTHH:mm:SS.nnnnnnZ", "data_modificacao":"YYYY-MM-DDTHH:mm:SS.nnnnnnZ", "estado":boolean, "administrador":boolean}, {"cpf":"string", ... }, ... ] } ou {"status":int, "message":"string","count":int, "data": [ {"usuario":"string", "email":"", "data_criacao":"YYYY-MM-DDTHH:mm:SS.nnnnnnZ", "data_modificacao":"YYYY-MM-DDTHH:mm:SS.nnnnnnZ"}, {"usuario": ... } ] }`,
		"",
	},
	"PessoaShow": rota{
		"GET",
		"/pessoas/{usuario}",
		"",
		`{"status":int, "message":"string", "count":int, "data": {"cpf":"string", "nome_completo":"string", "usuario":"string", "senha":"string", "email":"string", "data_criacao":"YYYY-MM-DDTHH:mm:SS.nnnnnnZ", "data_modificacao":"YYYY-MM-DDTHH:mm:SS.nnnnnnZ", "estado":boolean, "administrador":boolean} }`,
		"",
	},
	...
	"PessoaCreate": rota{
		...
		`{"status":int, "message":"string", "count":int, "data": {"cpf":"string", "nome_completo":"string", "usuario":"string", "senha":"string", "email":"string", "data_criacao":"YYYY-MM-DDTHH:mm:SS.nnnnnnnnn-nn:nn", "data_modificacao":"YYYY-MM-DDTHH:mm:SS.nnnnnnnnn-nn:nn", "estado":boolean, "administrador":boolean}}`,
		"",
	},
	"PessoaRemove": rota{
		"DELETE",
